/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 6882e862ac09a73f99b0d654d7b5bacb)
// Runtime types generated with workerd@1.20260826.1 2026-08-25
interface __BaseEnv_CloudflareBindings {
  DB: D1Database;
  ENVIRONMENT: "staging" | "development";
  POSTHOG_ACTIVITY_INBOXES:
    | '{"inbox_captioner_public":{"host":"https://eu.posthog.com","projectId":57374,"endpoint":"respondkit_customer_activity_v1","version":2}}'
    | "{}";
  GEMINI_MODEL: "gemini-3.1-flash-lite";
  TRANSLATION_ENABLED_INBOXES: '["inbox_respondkit_test","inbox_captioner_public"]' | "[]";
  DISCORD_API_BASE_URL: "https://discord.com/api/v10";
  TRANSLATION_WORKFLOW: Workflow<
    Parameters<import("./src/index").TranslationWorkflow["run"]>[0]["payload"]
  >;
  MESSAGE_WORKFLOW: Workflow<
    Parameters<import("./src/index").MessageWorkflow["run"]>[0]["payload"]
  >;
}
declare namespace Cloudflare {
  ...
  interface StagingEnv {
    DB: D1Database;
    ENVIRONMENT: "staging";
    POSTHOG_ACTIVITY_INBOXES: '{"inbox_captioner_public":{"host":"https://eu.posthog.com","projectId":57374,"endpoint":"respondkit_customer_activity_v1","version":2}}';
    GEMINI_MODEL: "gemini-3.1-flash-lite";
    TRANSLATION_ENABLED_INBOXES: '["inbox_respondkit_test","inbox_captioner_public"]';
    DISCORD_API_BASE_URL: "https://discord.com/api/v10";
    TRANSLATION_WORKFLOW: Workflow<
